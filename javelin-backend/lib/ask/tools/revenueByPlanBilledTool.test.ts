...
import { REVENUE_BY_PLAN_BILLED_INPUT_SCHEMA } from './revenueByPlanBilledTool';

describe('REVENUE_BY_PLAN_BILLED_INPUT_SCHEMA', () => {
  it('accepts valid ISO date range', () => {
    expect(() =>
      REVENUE_BY_PLAN_BILLED_INPUT_SCHEMA.parse({
        start: '2026-03-01',
        end: '2026-03-31',
      }),
    ).not.toThrow();
